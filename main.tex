\documentclass[124pt]{extarticle} % zmienić na 14 przed wyslaniem tj
...
%\input{rozdzialy/oriented_coloring.tex}

%\input{./rozdzialy/zadanie_2.tex}

%\section{Introduction}

\input{./rozdzialy/kolorowanie_intro.tex}

\input{./rozdzialy/rozne.tex}
