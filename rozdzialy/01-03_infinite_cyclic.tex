Let $X$ be the complement of a knot $K$ ($X=S^3-K$). Take $\widetilde{X}$ to be its universal covering, meaning that it is simply connected. The fundamental group $G=\pi_1(X)$ of $X$ acts on its universal covering by deck transformations. \hl{The commutator subgroup $K_G=[G, G]\triangleleft G$ acts on $\widetilde{X}$ and because $K_G$ is normal in $G$, the quotient $\overline{X}=\widetilde{X}/K_G$ has fundamental group $\pi_1(\overline{X})=K_G$ no matter the choice of the basepoint of $\overline{X}$.}
