...
\input{./rozdzialy/03-01-palettes-colorings.tex}

\subsection{Color checking matrix}
\label{section 3.2}

\input{rozdzialy/03-02-matrix-equivalence-relation.tex}

\subsection{Alexander palette}

\input{rozdzialy/03-03-alexander-palette.tex}

\subsection{Reidemeister relation on color checking matrices}

\input{rozdzialy/03-03-new_wyliczenie.tex}

\subsection{Smith normal form}

\input{rozdzialy/03-04-new_smith.tex}

\subsection{Color checking matrix and Alexander matrix}

\input{rozdzialy/03-06-connection.tex}
...
% }
%
% \input{rozdzialy/03-04-determinant.tex} 
%
