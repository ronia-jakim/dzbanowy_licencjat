...
\begin{definition}[diagram coloring]
  ...
  {\color{red}where $\pi_{x_j}:M^s\to M^3$ is a projection of the diagram to the segments that constitute $x_j$. TUTAJ NIE MOGĘ NAPISAĆ ŻE TO JEST RZUTOWANIE DIAGRAMU, TYLKO TRZEBA FORMALNIE}
\end{definition}
